...
if(valido){
Altanombre.setText("");Altaprecio.setText("");AltaStockMin.setText("");Altanombre.setText("");AltaStockActual.setText("");AltaStockMax.setText("");Altadescripcion.setText("");imagen=null;
lib.vaciarvisualizaralta(AltasProductos);altaProduProv.getSelectionModel().select(-1);}
      ...
      /*   BufferedImage bufferedImage = ImageIO.read(new ByteArrayInputStream(i.getImg()));
            ...
            ImageView a=new ImageView(imgProd);*/
               h.setPrefSize( 662,10);               
                Label id =new Label(String.valueOf(i.getId()));    Label nombre =new Label(i.getNombre());     Label stock =new Label(String.valueOf(i.getStockActual()));      
              id.setPrefSize(220, 17); nombre.setPrefSize(220, 17); stock.setPrefSize(225, 17); 
                                    id.setAlignment(Pos.CENTER); stock.setAlignment(Pos.CENTER);nombre.setAlignment(Pos.CENTER);
   ...
   vboxclientes(0);
    ...
    private void vboxclientes(int a) {
        byte op;
           VBox aux;
                    ...
                    if(a==0){op=0;aux=vboxBajasClientes;}else{op=1;aux=vboxModificacionesClientes;}
                     try{
    aux.getChildren().clear();
        ...
        for (Clientes i : lista) { 
           ...
           h.setPrefSize( 662,10);               
             Label id =new Label(String.valueOf(i.getId()));    Label dni =new Label(i.getDni()); Label nombre =new Label(i.getNombre());  Label direc =new Label(i.getDireccion());     Label tlf =new Label(i.getTelefono()); 
                               id.setPrefSize(50, 19); dni.setPrefSize(98, 19); nombre.setPrefSize(144, 19); direc.setPrefSize(257, 19); tlf.setPrefSize(112, 19); 
          id.setAlignment(Pos.CENTER); dni.setAlignment(Pos.CENTER);  nombre.setAlignment(Pos.CENTER);direc.setAlignment(Pos.CENTER);tlf.setAlignment(Pos.CENTER);
        ...
        for (Proveedores i : lista) { 
           ...
           h.setPrefSize( 662,10);               
                Label cif =new Label(i.getCif());  Label direc =new Label(i.getDireccion());     Label tlf =new Label(i.getTelefono());   Label correo=new Label(i.getCorreo());
                        cif.setPrefSize(58, 19); direc.setPrefSize(265, 19); tlf.setPrefSize(97, 19); correo.setPrefSize(223, 19); 
                        cif.setAlignment(Pos.CENTER); tlf.setAlignment(Pos.CENTER);  direc.setAlignment(Pos.CENTER);correo.setAlignment(Pos.CENTER);
    ...
    private void on_probajas(Event evt) {
        ...
        for (Proveedores i : lista) { 
           ...
           h.setPrefSize( 662,10);               
                Label cif =new Label(i.getCif());  Label direc =new Label(i.getDireccion());  Label correo=new Label(i.getCorreo());    Label tlf =new Label(i.getTelefono());  
                cif.setPrefSize(58, 19); direc.setPrefSize(265, 19); tlf.setPrefSize(97, 19); correo.setPrefSize(223, 19); 
          cif.setAlignment(Pos.CENTER); tlf.setAlignment(Pos.CENTER);  direc.setAlignment(Pos.CENTER);correo.setAlignment(Pos.CENTER);
                h.getChildren().addAll(cif,direc,tlf,correo);  
                        try {       
    ...
    private void on_enter(Event evt){
       ...
       switch(id){
           case "paneprodaltas":onDarDeAltaProducto(evt);break;
           case "paneprodmod":on_modificar_productos(evt);break;
           case "paneprovaltas":onAltaProovedor(evt);break;
           case "paneprovmod":onModificarProovedor(evt);break;
           case "paneclientesmod":onModificarCliente(evt);break;}
